...
o componente simples é a resposta certa. Ver o projeto [quando-abstrair](https://github.com/vmarins2005/quando-abstrair).
...
| `padroes-de-componentes-react` **(você está aqui)** | Compound, headless, slots, state reducer e estado controlavel: como absorver variacao sem explodir em props |
