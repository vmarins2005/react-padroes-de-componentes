...
o componente simples é a resposta certa. Ver o projeto [react-quando-abstrair](https://github.com/vmarins2005/react-quando-abstrair).
...
| `react-padroes-de-componentes` **(você está aqui)** | Compound, headless, slots, state reducer e estado controlavel: como absorver variacao sem explodir em props |
